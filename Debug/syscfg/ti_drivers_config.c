...
GPIO_PinConfig gpioPinConfigs[31] = {
    ...
    /* Owned by CONFIG_SPI_MASTER as MISO */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_NONE_INTERNAL, /* CONFIG_GPIO_SPI_MASTER_MISO */
    /* Owned by CONFIG_SPI_MASTER as MOSI */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW, /* CONFIG_GPIO_SPI_MASTER_MOSI */
    /* Owned by CONFIG_SPI_MASTER as SCLK */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW, /* CONFIG_GPIO_SPI_MASTER_SCLK */
    /* Owned by CONFIG_SPI_MASTER as SS */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_HIGH, /* CONFIG_GPIO_SPI_MASTER_SS */
    ...
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_HIGH, /* AD5490_CS */
    ...
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_HIGH, /* AD5940_RST */
...
const uint_least8_t CONFIG_SPI_MASTER_READY_CONST = CONFIG_SPI_MASTER_READY;
const uint_least8_t CONFIG_SPI_SLAVE_READY_CONST = CONFIG_SPI_SLAVE_READY;
const uint_least8_t AD5490_CS_CONST = AD5490_CS;
const uint_least8_t AD5940_RST_CONST = AD5940_RST;
const uint_least8_t CONFIG_GPIO_SPI_MASTER_SCLK_CONST = CONFIG_GPIO_SPI_MASTER_SCLK;
const uint_least8_t CONFIG_GPIO_SPI_MASTER_MISO_CONST = CONFIG_GPIO_SPI_MASTER_MISO;
const uint_least8_t CONFIG_GPIO_SPI_MASTER_MOSI_CONST = CONFIG_GPIO_SPI_MASTER_MOSI;
...
const uint_least8_t CONFIG_GPIO_SPI_MASTER_SS_CONST = CONFIG_GPIO_SPI_MASTER_SS;
...
const SPICC26X2DMA_HWAttrs spiCC26X2DMAHWAttrs[CONFIG_SPI_COUNT] = {
    ...
    /* LaunchPad SPI Bus with Chip Select */
    {
        ...
        .mosiPin = CONFIG_GPIO_SPI_MASTER_MOSI,
        .misoPin = CONFIG_GPIO_SPI_MASTER_MISO,
        .clkPin  = CONFIG_GPIO_SPI_MASTER_SCLK,
        .csnPin  = CONFIG_GPIO_SPI_MASTER_SS
    },
};
